...
contract NFTMarketplace is ReentrancyGuard{
    ...
    function createMarketItem(
        ...
        require (price > 0, "Price must be equal or greater than listing price");

        require(msg.value == listingPrice, "Price must bet equal to listing price");
        _itemIds.increment();
    ...
    function fetchMarketItems() public view returns (MarketItem[] memory){
        ...
        uint unsoldItemCount = itemsCount - _itemsSold.current();
        uint currentIndex = 0;
    ...
    function ItemsCreate() public view returns(MarketItem[] memory){
        uint totalItemsCount = _itemIds.current();
        uint totalItems = 0;
        uint currentIndex = 0;
